...
export default function Hero() {
    return (
        <section id="Hero" className="h-[80vh] w-auto flex flex-col justify-center items-center text-start px-4 md:px-8 relative bg-blue-100 mt-20 mx-4 sm:mx-8 md:mx-10">
            ...
            <div className="z-10 mt-10">
                ...
                <button>
                    <Link href="/" className="text-xs sm:text-xs md:text-base py-2 px-4 sm:py-3 sm:px-7 md:py-4 md:px-8 rounded-full text-white  hover:bg-blue-700 transition duration-300 ease-in-out gradient-bg font-semibold">                
